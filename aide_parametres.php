...
<title><?php echo htmlspecialchars(t('aide_parametres.page_title_tag')); ?></title>
...
.toc-list { list-style: none; margin: 0; padding: 0 8px 10px; display: none; max-height: 74vh; overflow-y: auto; }
.toc-toggle:checked ~ .toc-list { display: block; }
.toc-list a { display: flex; align-items: center; gap: 10px; padding: 8px 10px; border-radius: 8px; color: #5a6b7a; text-decoration: none; font-size: 0.84rem; font-weight: 600; transition: 0.15s; }
...
<?php $breadcrumb_parent_label = t('aide_hub.breadcrumb'); $breadcrumb_parent_href = 'aide.php'; $breadcrumb_label = t('aide_hub.tuile_parametres_titre'); include 'navbar.php'; ?>

<div class="main-content">

    <div class="crumb"><span><i class="fa-solid fa-house"></i> <?php echo htmlspecialchars(t('aide_common.centre_aide')); ?></span> <span>/</span> <span><?php echo htmlspecialchars(t('aide_hub.tuile_parametres_titre')); ?></span></div>
    ...
    <div class="hero">
        ...
        <h1><?php echo htmlspecialchars(t('aide_hub.tuile_parametres_titre')); ?></h1>
        <p class="tagline"><?php echo htmlspecialchars(t('aide_parametres.hero_tagline')); ?></p>
        <div class="hero-meta">
            <span class="hero-pill"><?php echo t('aide_parametres.pill_version'); ?></span>
            <span class="hero-pill"><?php echo t('aide_parametres.pill_updated'); ?></span>
            <span class="hero-pill"><?php echo t('aide_parametres.pill_ecran'); ?></span>
            <span class="hero-pill"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.pill_reserve_admins')); ?></span>
        </div>
    </div>
    ...
    <div class="layout">
        <nav class="toc-card" aria-label="<?php echo htmlspecialchars(t('aide_common.sommaire')); ?>">
            ...
            <ul class="toc-list">
                <li><a href="#vue-ensemble"><i class="fa-solid fa-circle-info"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_vue_ensemble')); ?></a></li>
                <li><a href="#general"><i class="fa-solid fa-building"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_general')); ?></a></li>
                <li><a href="#types"><i class="fa-solid fa-sitemap"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_types')); ?></a></li>
                <li><a href="#services"><i class="fa-solid fa-people-group"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_services')); ?></a></li>
                ...
                <li class="toc-sep"></li>
                <li><a href="#astuces"><i class="fa-solid fa-lightbulb"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_astuces')); ?></a></li>
                <li><a href="#glossaire"><i class="fa-solid fa-book"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_glossaire')); ?></a></li>
        ...
        <main class="content">
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-circle-info"></i><h2><?php echo htmlspecialchars(t('aide_parametres.toc_vue_ensemble')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parametres.vue_ensemble_lede'); ?></p>

                    <div class="tab-pills">
                        <span class="tab-pill"><i class="fa-solid fa-building"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_general')); ?></span>
                        <span class="tab-pill"><i class="fa-solid fa-sitemap"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_types')); ?></span>
                        <span class="tab-pill"><i class="fa-solid fa-people-group"></i> <?php echo htmlspecialchars(t('aide_parametres.toc_services')); ?></span>
                    ...
                    <div class="callout callout-tip">
                        ...
                        <div><p><?php echo t('aide_parametres.vue_ensemble_tip'); ?></p></div>
                    </div>
                </section>

                <section id="general" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-building"></i><h2><?php echo htmlspecialchars(t('aide_parametres.general_h2')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_parametres.general_lede')); ?></p>

                    <div class="shot">
                        <img src="img/aide/parametres_general.png" alt="<?php echo htmlspecialchars(t('aide_parametres.shot_general_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_parametres.shot_general_cap')); ?></div>
                    </div>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_parametres.tbl_champ')); ?></th><th><?php echo htmlspecialchars(t('aide_parametres.tbl_detail')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.general_champ1_nom')); ?></td><td><?php echo htmlspecialchars(t('aide_parametres.general_champ1_d')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.general_champ2_nom')); ?></td><td><?php echo htmlspecialchars(t('aide_parametres.general_champ2_d')); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>

                <section id="types" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-sitemap"></i><h2><?php echo htmlspecialchars(t('aide_parametres.types_h2')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parametres.types_lede'); ?></p>

                    <div class="steps">
                        <div class="step">
                            <div class="step-num">+</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parametres.types_step1_title')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parametres.types_step1_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num"><i class="fa-solid fa-pen" style="font-size:0.9rem;"></i></div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parametres.types_step2_title')); ?></h4>
                            <p><?php echo t('aide_parametres.types_step2_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num"><i class="fa-solid fa-trash" style="font-size:0.85rem;"></i></div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parametres.types_step3_title')); ?></h4>
                            <p><?php echo t('aide_parametres.types_step3_desc'); ?></p></div>
                        </div>
                    </div>
                </section>

                <section id="services" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-people-group"></i><h2><?php echo htmlspecialchars(t('aide_parametres.services_h2')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parametres.services_lede'); ?></p>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_parametres.tbl_action')); ?></th><th><?php echo htmlspecialchars(t('aide_parametres.tbl_regle')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.services_row1_action')); ?></td><td><?php echo htmlspecialchars(t('aide_parametres.services_row1_regle')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.services_row2_action')); ?></td><td><?php echo htmlspecialchars(t('aide_parametres.services_row2_regle')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.services_row3_action')); ?></td><td><?php echo t('aide_parametres.services_row3_regle'); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>

                <section id="categories" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-calendar-check"></i><h2><?php echo htmlspecialchars(t('aide_parametres.categories_h2')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_parametres.categories_lede')); ?></p>

                    <p><?php echo htmlspecialchars(t('aide_parametres.categories_p')); ?></p>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_parametres.categories_warn'); ?></p></div>
                    </div>
                </section>

                <section id="statuts" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-flag"></i><h2><?php echo htmlspecialchars(t('aide_parametres.statuts_h2')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parametres.statuts_lede'); ?></p>

                    <div class="callout callout-lock">
                        <i class="fa-solid fa-lock"></i>
                        <div><p><?php echo t('aide_parametres.statuts_lock'); ?></p></div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-language"></i>
                        <div><p><?php echo t('aide_parametres.statuts_tip'); ?></p></div>
                    </div>
                </section>

                <section id="planning" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-calendar-days"></i><h2><?php echo htmlspecialchars(t('aide_parametres.planning_h2')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parametres.planning_lede'); ?></p>

                    <div class="shot">
                        <img src="img/aide/parametres_planning.png" alt="<?php echo htmlspecialchars(t('aide_parametres.shot_planning_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_parametres.shot_planning_cap')); ?></div>
                    </div>

                    <h3><?php echo htmlspecialchars(t('aide_parametres.planning_h3_listes')); ?></h3>
                    <p><?php echo htmlspecialchars(t('aide_parametres.planning_listes_p')); ?></p>
                    <ul>
                        <li><?php echo t('aide_parametres.planning_li_postes'); ?></li>
                        <li><?php echo t('aide_parametres.planning_li_evenements'); ?></li>
                        <li><?php echo t('aide_parametres.planning_li_astreintes'); ?></li>
                    </ul>

                    <h3><?php echo htmlspecialchars(t('aide_parametres.planning_h3_objectifs')); ?></h3>
                    <p><?php echo t('aide_parametres.planning_objectifs_p'); ?></p>

                    <h3><?php echo htmlspecialchars(t('aide_parametres.planning_h3_import')); ?></h3>
                    <div class="grid-2">
                        <div class="route-card alt">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_parametres.reset_planning_tag')); ?></span>
                            <h3><i class="fa-solid fa-eraser"></i> <?php echo htmlspecialchars(t('aide_parametres.reset_planning_h3')); ?></h3>
                            <p><?php echo t('aide_parametres.reset_planning_p'); ?></p>
                        </div>
                        <div class="route-card alt">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_parametres.reset_heures_tag')); ?></span>
                            <h3><i class="fa-solid fa-hourglass"></i> <?php echo htmlspecialchars(t('aide_parametres.reset_heures_h3')); ?></h3>
                            <p><?php echo t('aide_parametres.reset_heures_p'); ?></p>
                        </div>
                    </div>
                ...
                <section id="tuiles" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-palette"></i><h2><?php echo htmlspecialchars(t('aide_parametres.tuiles_h2')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_parametres.tuiles_lede')); ?></p>

                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-table-cells"></i> <?php echo htmlspecialchars(t('aide_parametres.tuiles_fixes_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parametres.tuiles_fixes_p')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-folder"></i> <?php echo htmlspecialchars(t('aide_parametres.dossiers_h4')); ?></h4>
                            <p><?php echo t('aide_parametres.dossiers_p'); ?></p>
                        </div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-circle-info"></i>
                        <div><p><?php echo t('aide_parametres.tuiles_tip'); ?></p></div>
                    </div>
                </section>

                <section id="droits" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_parametres.toc_droits')); ?></h2></div>
                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_parametres.droits_action')); ?></th><th><?php echo htmlspecialchars(t('aide_parametres.droits_tech')); ?></th><th><?php echo htmlspecialchars(t('aide_parametres.droits_admin')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.droits1')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parametres.droits2')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> —</span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>
                ...
                <section id="astuces" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-lightbulb"></i><h2><?php echo htmlspecialchars(t('aide_parametres.toc_astuces')); ?></h2></div>
                    <ul>
                        <li><?php echo t('aide_parametres.astuces_li1'); ?></li>
                        <li><?php echo t('aide_parametres.astuces_li2'); ?></li>
                        <li><?php echo t('aide_parametres.astuces_li3'); ?></li>
                        <li><?php echo t('aide_parametres.astuces_li4'); ?></li>
                        <li><?php echo t('aide_parametres.astuces_li5'); ?></li>
                    </ul>
                </section>

                <section id="glossaire" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-book"></i><h2><?php echo htmlspecialchars(t('aide_parametres.toc_glossaire')); ?></h2></div>
                    <dl class="gloss">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <div><dt><?php echo htmlspecialchars(t("aide_parametres.gloss{$i}_dt")); ?></dt><dd><?php echo htmlspecialchars(t("aide_parametres.gloss{$i}_dd")); ?></dd></div>
                        <?php endfor; ?>
                    </dl>
                </section>
                ...
                <section id="roadmap" class="aide-sec" style="margin-bottom:0;">
                    ...
                    <details class="devnote">
                        ...
                        <p style="margin-top:8px; font-size:0.88rem; color:#5a6b7a;"><?php echo htmlspecialchars(t('aide_parametres.devnote_intro')); ?></p>
                        <ul style="font-size:0.88rem; color:#5a6b7a;">
                            <li><?php echo t('aide_parametres.devnote_li1'); ?></li>
                            <li><?php echo t('aide_parametres.devnote_li2'); ?></li>
                            <li><?php echo t('aide_parametres.devnote_li3'); ?></li>
                            <li><?php echo t('aide_parametres.devnote_li4'); ?></li>
                        </ul>
                    </details>
                    <?php endif; ?>
