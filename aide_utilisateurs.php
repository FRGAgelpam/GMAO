...
<title><?php echo htmlspecialchars(t('aide_utilisateurs.page_title_tag')); ?></title>
...
@media (min-width: 980px) { .cases.three { grid-template-columns: repeat(3, minmax(0, 1fr)); } }
...
<?php $breadcrumb_parent_label = t('aide_hub.breadcrumb'); $breadcrumb_parent_href = 'aide.php'; $breadcrumb_label = t('aide_hub.tuile_utilisateurs_titre'); include 'navbar.php'; ?>

<div class="main-content">

    <div class="crumb"><span><i class="fa-solid fa-house"></i> <?php echo htmlspecialchars(t('aide_common.centre_aide')); ?></span> <span>/</span> <span><?php echo htmlspecialchars(t('aide_hub.tuile_utilisateurs_titre')); ?></span></div>
    ...
    <div class="hero">
        ...
        <h1><?php echo htmlspecialchars(t('aide_hub.tuile_utilisateurs_titre')); ?></h1>
        <p class="tagline"><?php echo htmlspecialchars(t('aide_utilisateurs.hero_tagline')); ?></p>
        <div class="hero-meta">
            <span class="hero-pill"><?php echo t('aide_utilisateurs.pill_version'); ?></span>
            <span class="hero-pill"><?php echo t('aide_utilisateurs.pill_updated'); ?></span>
            <span class="hero-pill"><?php echo t('aide_utilisateurs.pill_ecran'); ?></span>
    ...
    <div class="layout">
        <nav class="toc-card" aria-label="<?php echo htmlspecialchars(t('aide_common.sommaire')); ?>">
            ...
            <ul class="toc-list">
                <li><a href="#vue-ensemble"><i class="fa-solid fa-circle-info"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_vue_ensemble')); ?></a></li>
                <li><a href="#roles"><i class="fa-solid fa-user-tag"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_roles')); ?></a></li>
                <li><a href="#creer"><i class="fa-solid fa-user-plus"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_creer')); ?></a></li>
                <li><a href="#modifier"><i class="fa-solid fa-pen"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_modifier')); ?></a></li>
                <li><a href="#mot-de-passe"><i class="fa-solid fa-key"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_mdp')); ?></a></li>
                <li><a href="#pin"><i class="fa-solid fa-hashtag"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_pin')); ?></a></li>
                <li><a href="#activer"><i class="fa-solid fa-power-off"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_activer')); ?></a></li>
                <li><a href="#supprimer"><i class="fa-solid fa-trash-can"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_supprimer')); ?></a></li>
                <li><a href="#securite"><i class="fa-solid fa-shield-halved"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_securite')); ?></a></li>
                <li><a href="#droits"><i class="fa-solid fa-shield-halved"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_droits')); ?></a></li>
                <li class="toc-sep"></li>
                <li><a href="#astuces"><i class="fa-solid fa-lightbulb"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_astuces')); ?></a></li>
                <li><a href="#glossaire"><i class="fa-solid fa-book"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.toc_glossaire')); ?></a></li>
        ...
        <main class="content">
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-circle-info"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_vue_ensemble')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_utilisateurs.vue_ensemble_lede'); ?></p>

                    <div class="cases three">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-screwdriver-wrench" style="color:var(--gelpam-green);"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.case1_h4')); ?></h4>
                            <p><?php echo t('aide_utilisateurs.case1_p'); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-door-open" style="color:var(--gelpam-orange);"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.case2_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_utilisateurs.case2_p')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-users" style="color:var(--accent);"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.case3_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_utilisateurs.case3_p')); ?></p>
                        </div>
                    </div>
                </section>

                <section id="roles" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-user-tag"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_roles')); ?></h2></div>
                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_utilisateurs.roles_tbl_role')); ?></th><th><?php echo htmlspecialchars(t('aide_utilisateurs.roles_tbl_donne')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_utilisateurs.role1_nom')); ?></td><td><?php echo htmlspecialchars(t('aide_utilisateurs.role1_desc')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_utilisateurs.role2_nom')); ?></td><td><?php echo htmlspecialchars(t('aide_utilisateurs.role2_desc')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_utilisateurs.role3_nom')); ?></td><td><?php echo htmlspecialchars(t('aide_utilisateurs.role3_desc')); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="callout callout-tip">
                        ...
                        <div><p><?php echo t('aide_utilisateurs.roles_tip'); ?></p></div>
                    </div>
                </section>

                <section id="creer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-user-plus"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_creer')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_utilisateurs.creer_lede'); ?></p>

                    <div class="grid-2">
                        <div class="route-card">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_utilisateurs.mode1_tag')); ?></span>
                            <h3><i class="fa-solid fa-door-open"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.mode1_h3')); ?></h3>
                            <p><?php echo t('aide_utilisateurs.mode1_p'); ?></p>
                        </div>
                        <div class="route-card alt">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_utilisateurs.mode2_tag')); ?></span>
                            <h3><i class="fa-solid fa-id-badge"></i> <?php echo htmlspecialchars(t('aide_utilisateurs.mode2_h3')); ?></h3>
                            <p><?php echo t('aide_utilisateurs.mode2_p'); ?></p>
                        </div>
                    </div>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_utilisateurs.creer_tbl_champ')); ?></th><th><?php echo htmlspecialchars(t('aide_utilisateurs.creer_tbl_detail')); ?></th></tr></thead>
                            <tbody>
                                <?php for ($i = 1; $i <= 7; $i++): ?>
                                <tr><td><?php echo htmlspecialchars(t("aide_utilisateurs.champ{$i}_nom")); ?></td><td><?php echo htmlspecialchars(t("aide_utilisateurs.champ{$i}_d")); ?></td></tr>
                                <?php endfor; ?>
                            </tbody>
                        </table>
                    </div>

                    <p><?php echo t('aide_utilisateurs.creer_footer'); ?></p>
                </section>

                <section id="modifier" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-pen"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_modifier')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_utilisateurs.modifier_lede')); ?></p>

                    <p><?php echo t('aide_utilisateurs.modifier_p2'); ?></p>
                </section>

                <section id="mot-de-passe" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-key"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_mdp')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_utilisateurs.mdp_lede'); ?></p>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-circle-info"></i>
                        <div><p><?php echo t('aide_utilisateurs.mdp_tip'); ?></p></div>
                    </div>
                </section>

                <section id="pin" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-hashtag"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_pin')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_utilisateurs.pin_lede')); ?></p>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-wand-magic-sparkles"></i>
                        <div><p><?php echo t('aide_utilisateurs.pin_tip'); ?></p></div>
                    </div>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-eye"></i>
                        <div><p><?php echo t('aide_utilisateurs.pin_warn'); ?></p></div>
                    </div>
                </section>

                <section id="activer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-power-off"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_activer')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_utilisateurs.activer_lede'); ?></p>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_utilisateurs.activer_warn'); ?></p></div>
                    </div>
                </section>

                <section id="supprimer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-trash-can"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_supprimer')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_utilisateurs.supprimer_lede')); ?></p>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_utilisateurs.supprimer_warn'); ?></p></div>
                    </div>
                </section>

                <section id="securite" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_securite')); ?></h2></div>
                    <ul>
                        <li><?php echo t('aide_utilisateurs.securite_li1'); ?></li>
                        <li><?php echo t('aide_utilisateurs.securite_li2'); ?></li>
                        <li><?php echo t('aide_utilisateurs.securite_li3'); ?></li>
                        <li><?php echo t('aide_utilisateurs.securite_li4'); ?></li>
                    </ul>
                </section>

                <section id="droits" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_droits')); ?></h2></div>
                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_utilisateurs.droits_action')); ?></th><th><?php echo htmlspecialchars(t('aide_utilisateurs.droits_tech')); ?></th><th><?php echo htmlspecialchars(t('aide_utilisateurs.droits_admin')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_utilisateurs.droits1')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_utilisateurs.droits2')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> —</span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_utilisateurs.droits3')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> —</span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>
                ...
                <section id="astuces" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-lightbulb"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_astuces')); ?></h2></div>
                    <ul>
                        <li><?php echo t('aide_utilisateurs.astuces_li1'); ?></li>
                        <li><?php echo t('aide_utilisateurs.astuces_li2'); ?></li>
                        <li><?php echo t('aide_utilisateurs.astuces_li3'); ?></li>
                        <li><?php echo t('aide_utilisateurs.astuces_li4'); ?></li>
                    </ul>
                </section>

                <section id="glossaire" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-book"></i><h2><?php echo htmlspecialchars(t('aide_utilisateurs.toc_glossaire')); ?></h2></div>
                    <dl class="gloss">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <div><dt><?php echo htmlspecialchars(t("aide_utilisateurs.gloss{$i}_dt")); ?></dt><dd><?php echo htmlspecialchars(t("aide_utilisateurs.gloss{$i}_dd")); ?></dd></div>
                        <?php endfor; ?>
                    </dl>
                </section>
                ...
                <section id="roadmap" class="aide-sec" style="margin-bottom:0;">
                    ...
                    <details class="devnote">
                        ...
                        <p style="margin-top:8px; font-size:0.88rem; color:#5a6b7a;"><?php echo htmlspecialchars(t('aide_utilisateurs.devnote_intro')); ?></p>
                        <ul style="font-size:0.88rem; color:#5a6b7a;">
                            <li><?php echo t('aide_utilisateurs.devnote_li1'); ?></li>
                            <li><?php echo t('aide_utilisateurs.devnote_li2'); ?></li>
                            <li><?php echo t('aide_utilisateurs.devnote_li3'); ?></li>
                            <li><?php echo htmlspecialchars(t('aide_utilisateurs.devnote_li4')); ?></li>
                        </ul>
                    </details>
                    <?php endif; ?>
