...
<title><?php echo htmlspecialchars(t('aide_preventif.page_title_tag')); ?></title>
...
<?php $breadcrumb_parent_label = t('aide_hub.breadcrumb'); $breadcrumb_parent_href = 'aide.php'; $breadcrumb_label = t('aide_hub.tuile_preventif_titre'); include 'navbar.php'; ?>

<div class="main-content">

    <div class="crumb"><span><i class="fa-solid fa-house"></i> <?php echo htmlspecialchars(t('aide_common.centre_aide')); ?></span> <span>/</span> <span><?php echo htmlspecialchars(t('aide_hub.tuile_preventif_titre')); ?></span></div>
    ...
    <div class="hero">
        ...
        <h1><?php echo htmlspecialchars(t('aide_hub.tuile_preventif_titre')); ?></h1>
        <p class="tagline"><?php echo htmlspecialchars(t('aide_preventif.hero_tagline')); ?></p>
        <div class="hero-meta">
            <span class="hero-pill"><?php echo t('aide_preventif.pill_version'); ?></span>
            <span class="hero-pill"><?php echo t('aide_preventif.pill_updated'); ?></span>
            <span class="hero-pill"><?php echo t('aide_preventif.pill_ecrans'); ?></span>
    ...
    <div class="layout">
        <nav class="toc-card" aria-label="<?php echo htmlspecialchars(t('aide_common.sommaire')); ?>">
            ...
            <ul class="toc-list">
                <li><a href="#vue-ensemble"><i class="fa-solid fa-circle-info"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_vue_ensemble')); ?></a></li>
                <li><a href="#liste"><i class="fa-solid fa-list-check"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_liste')); ?></a></li>
                <li><a href="#creer"><i class="fa-solid fa-wand-magic-sparkles"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_creer')); ?></a></li>
                <li><a href="#travaux-divers"><i class="fa-solid fa-square-check"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_travaux_divers')); ?></a></li>
                <li><a href="#generation"><i class="fa-solid fa-gears"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_generation')); ?></a></li>
                <li><a href="#gestion"><i class="fa-solid fa-pause"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_gestion')); ?></a></li>
                <li><a href="#planning"><i class="fa-solid fa-calendar-days"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_planning')); ?></a></li>
                <li class="toc-sep"></li>
                <li><a href="#astuces"><i class="fa-solid fa-lightbulb"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_astuces')); ?></a></li>
                <li><a href="#glossaire"><i class="fa-solid fa-book"></i> <?php echo htmlspecialchars(t('aide_preventif.toc_glossaire')); ?></a></li>
            </ul>
        </nav>
        ...
        <main class="content">
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-circle-info"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_vue_ensemble')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_preventif.vue_ensemble_lede'); ?></p>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_preventif.tbl_ecran')); ?></th><th><?php echo htmlspecialchars(t('aide_preventif.tbl_qui')); ?></th><th><?php echo htmlspecialchars(t('aide_preventif.tbl_pourquoi')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_preventif.row_preventif_ecran')); ?></td><td><span class="pill pill-admin"><span class="pill-dot"></span><?php echo htmlspecialchars(t('aide_common.pill_admin_uniquement')); ?></span></td><td><?php echo htmlspecialchars(t('aide_preventif.row_preventif_pourquoi')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_preventif.row_planning_ecran')); ?></td><td><span class="pill pill-all"><span class="pill-dot"></span><?php echo htmlspecialchars(t('tag.tous_roles')); ?></span></td><td><?php echo htmlspecialchars(t('aide_preventif.row_planning_pourquoi')); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="callout callout-lock">
                        ...
                        <div><p><?php echo t('aide_preventif.vue_ensemble_lock'); ?></p></div>
                    </div>
                </section>

                <section id="liste" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-list-check"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_liste')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_preventif.liste_lede')); ?></p>

                    <div class="shot">
                        <img src="img/aide/preventif_liste_regles.png" alt="<?php echo htmlspecialchars(t('aide_preventif.shot_liste_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_preventif.shot_liste_cap')); ?></div>
                    </div>

                    <ul>
                        <li><?php echo htmlspecialchars(t('aide_preventif.liste_li1')); ?></li>
                        <li><?php echo t('aide_preventif.liste_li2'); ?></li>
                        <li><?php echo t('aide_preventif.liste_li3'); ?></li>
                    </ul>
                </section>

                <section id="creer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-wand-magic-sparkles"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_creer')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_preventif.creer_lede'); ?></p>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-square-check"></i>
                        <div><p><?php echo t('aide_preventif.creer_tip'); ?></p></div>
                    </div>

                    <div class="steps">
                        <div class="step">
                            <div class="step-num">1</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.step1_title')); ?></h4>
                            <p><?php echo t('aide_preventif.step1_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">2</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.step2_title')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_preventif.step2_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">3</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.step3_title')); ?></h4>
                            <p><?php echo t('aide_preventif.step3_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">4</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.step4_title')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_preventif.step4_desc')); ?></p></div>
                        </div>
                    </div>

                    <div class="shot-row">
                        <div class="shot">
                            <img src="img/aide/preventif_wizard_etape1.png" alt="<?php echo htmlspecialchars(t('aide_preventif.shot_e1_alt')); ?>">
                            <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_preventif.shot_e1_cap')); ?></div>
                        </div>
                        <div class="shot">
                            <img src="img/aide/preventif_wizard_etape2.png" alt="<?php echo htmlspecialchars(t('aide_preventif.shot_e2_alt')); ?>">
                            <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_preventif.shot_e2_cap')); ?></div>
                        </div>
                        <div class="shot">
                            <img src="img/aide/preventif_wizard_etape3.png" alt="<?php echo htmlspecialchars(t('aide_preventif.shot_e3_alt')); ?>">
                            <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_preventif.shot_e3_cap')); ?></div>
                        </div>
                        <div class="shot">
                            <img src="img/aide/preventif_wizard_etape4.png" alt="<?php echo htmlspecialchars(t('aide_preventif.shot_e4_alt')); ?>">
                            <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_preventif.shot_e4_cap')); ?></div>
                        </div>
                    </div>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_preventif.creer_warn'); ?></p></div>
                    </div>
                </section>

                <section id="travaux-divers" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-square-check"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_travaux_divers')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_preventif.travaux_lede'); ?></p>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-circle-info"></i>
                        <div><p><?php echo t('aide_preventif.travaux_tip'); ?></p></div>
                    </div>

                    <div class="steps">
                        <div class="step">
                            <div class="step-num"><i class="fa-solid fa-pen"></i></div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.travaux_champs_title')); ?></h4>
                            <p><?php echo t('aide_preventif.travaux_champs_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num"><i class="fa-solid fa-circle-check"></i></div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.travaux_statut_title')); ?></h4>
                            <p><?php echo t('aide_preventif.travaux_statut_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num"><i class="fa-solid fa-magnifying-glass"></i></div>
                            <div><h4><?php echo htmlspecialchars(t('aide_preventif.travaux_recherche_title')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_preventif.travaux_recherche_desc')); ?></p></div>
                        </div>
                    </div>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-calendar-days"></i>
                        <div><p><?php echo t('aide_preventif.travaux_warn'); ?></p></div>
                    </div>
                </section>

                <section id="generation" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-gears"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_generation')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_preventif.generation_lede')); ?></p>

                    <ul>
                        <li><?php echo t('aide_preventif.generation_li1'); ?></li>
                        <li><?php echo t('aide_preventif.generation_li2'); ?></li>
                        <li><?php echo htmlspecialchars(t('aide_preventif.generation_li3')); ?></li>
                    </ul>

                    <div class="callout callout-lock">
                        <i class="fa-solid fa-clock-rotate-left"></i>
                        <div><p><?php echo htmlspecialchars(t('aide_preventif.generation_lock')); ?></p></div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-bolt"></i>
                        <div><p><?php echo t('aide_preventif.generation_tip1'); ?></p></div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-clipboard-list"></i>
                        <div><p><?php echo htmlspecialchars(t('aide_preventif.generation_tip2')); ?></p></div>
                    </div>
                </section>

                <section id="gestion" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-pause"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_gestion')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_preventif.gestion_lede')); ?></p>

                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-pen"></i> <?php echo htmlspecialchars(t('aide_preventif.gestion_modifier_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_preventif.gestion_modifier_p')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-pause"></i> <?php echo htmlspecialchars(t('aide_preventif.gestion_pause_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_preventif.gestion_pause_p')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-trash"></i> <?php echo htmlspecialchars(t('aide_preventif.gestion_supprimer_h4')); ?></h4>
                            <p><?php echo t('aide_preventif.gestion_supprimer_p'); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-clock-rotate-left"></i> <?php echo htmlspecialchars(t('aide_preventif.gestion_historique_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_preventif.gestion_historique_p')); ?></p>
                        </div>
                    </div>
                </section>

                <section id="planning" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-calendar-days"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_planning')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_preventif.planning_lede')); ?></p>

                    <div class="shot">
                        <img src="img/aide/planning_grille_semaine.png" alt="<?php echo htmlspecialchars(t('aide_preventif.shot_grille_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_preventif.shot_grille_cap')); ?></div>
                    </div>

                    <ul>
                        <li><?php echo htmlspecialchars(t('aide_preventif.planning_li1')); ?></li>
                        <li><?php echo t('aide_preventif.planning_li2'); ?></li>
                        <li><?php echo htmlspecialchars(t('aide_preventif.planning_li3')); ?></li>
                        <li><?php echo htmlspecialchars(t('aide_preventif.planning_li4')); ?></li>
                    </ul>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_preventif.planning_warn'); ?></p></div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-scale-balanced"></i>
                        <div><p><?php echo t('aide_preventif.planning_tip'); ?></p></div>
                    </div>
                </section>

                <section id="astuces" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-lightbulb"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_astuces')); ?></h2></div>
                    <ul>
                        <li><?php echo t('aide_preventif.astuces_li1'); ?></li>
                        <li><?php echo t('aide_preventif.astuces_li2'); ?></li>
                        <li><?php echo t('aide_preventif.astuces_li3'); ?></li>
                        <li><?php echo t('aide_preventif.astuces_li4'); ?></li>
                        <li><?php echo t('aide_preventif.astuces_li5'); ?></li>
                    </ul>
                </section>

                <section id="glossaire" class="aide-sec" style="margin-bottom:0;">
                    <div class="sec-eyebrow"><i class="fa-solid fa-book"></i><h2><?php echo htmlspecialchars(t('aide_preventif.toc_glossaire')); ?></h2></div>
                    <dl class="gloss">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <div><dt><?php echo htmlspecialchars(t("aide_preventif.gloss{$i}_dt")); ?></dt><dd><?php echo htmlspecialchars(t("aide_preventif.gloss{$i}_dd")); ?></dd></div>
                        <?php endfor; ?>
                    </dl>
                    ...
                    <details class="devnote">
                        ...
                        <ul style="font-size:0.88rem; color:#5a6b7a; margin-top:8px;">
                            <li><?php echo t('aide_preventif.devnote_li1'); ?></li>
                            <li><?php echo t('aide_preventif.devnote_li2'); ?></li>
                            <li><?php echo t('aide_preventif.devnote_li3'); ?></li>
                        </ul>
                    </details>
                    <?php endif; ?>
