            ...
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    ...
                    <div class="tree-demo">
                        ...
                        <span class="sep">→</span>
                        <span class="tn" style="background:var(--brand-orange);"><i class="fa-solid fa-layer-group"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_secteur')); ?></span>
                        <span class="sep">→</span>
                        ...
                        <span class="sep">→</span>
                        <span class="tn" style="background:var(--brand-green);"><i class="fa-solid fa-location-dot"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_zone')); ?></span>
                        <span class="sep">→</span>
