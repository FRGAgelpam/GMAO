...
<title><?php echo htmlspecialchars(t('aide_parc_machine.page_title_tag')); ?></title>
...
@media (min-width: 980px) { .cases.five { grid-template-columns: repeat(5, minmax(0, 1fr)); } }
...
.tree-demo { display: flex; flex-wrap: wrap; align-items: center; gap: 8px; background: #f7f9fb; border: 1px solid #e6e9ec; border-radius: 12px; padding: 16px 18px; margin: 16px 0; font-family: 'Montserrat', sans-serif; font-weight: 700; font-size: 0.86rem; }
.tree-demo .tn { display: flex; align-items: center; gap: 6px; padding: 6px 12px; border-radius: 8px; color: #fff; }
.tree-demo .tn i { font-size: 0.85rem; }
.tree-demo .sep { color: #c3cdd6; }
</style>
...
<?php $breadcrumb_parent_label = t('aide_hub.breadcrumb'); $breadcrumb_parent_href = 'aide.php'; $breadcrumb_label = t('aide_hub.tuile_parc_machine_titre'); include 'navbar.php'; ?>

<div class="main-content">

    <div class="crumb"><span><i class="fa-solid fa-house"></i> <?php echo htmlspecialchars(t('aide_common.centre_aide')); ?></span> <span>/</span> <span><?php echo htmlspecialchars(t('aide_hub.tuile_parc_machine_titre')); ?></span></div>
    ...
    <div class="hero">
        ...
        <h1><?php echo htmlspecialchars(t('aide_hub.tuile_parc_machine_titre')); ?></h1>
        <p class="tagline"><?php echo htmlspecialchars(t('aide_parc_machine.hero_tagline')); ?></p>
        <div class="hero-meta">
            <span class="hero-pill"><?php echo t('aide_parc_machine.pill_version'); ?></span>
            <span class="hero-pill"><?php echo t('aide_parc_machine.pill_updated'); ?></span>
            <span class="hero-pill"><?php echo t('aide_parc_machine.pill_ecrans'); ?></span>
            <span class="hero-pill"><i class="fa-solid fa-eye"></i> <?php echo htmlspecialchars(t('aide_parc_machine.pill_lecture')); ?></span>
        </div>
    </div>
    ...
    <div class="layout">
        <nav class="toc-card" aria-label="<?php echo htmlspecialchars(t('aide_common.sommaire')); ?>">
            ...
            <ul class="toc-list">
                <li><a href="#vue-ensemble"><i class="fa-solid fa-circle-info"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_vue_ensemble')); ?></a></li>
                <li><a href="#explorer"><i class="fa-solid fa-magnifying-glass"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_explorer')); ?></a></li>
                <li><a href="#ajouter"><i class="fa-solid fa-plus"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_ajouter')); ?></a></li>
                <li><a href="#modifier"><i class="fa-solid fa-pen"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_modifier')); ?></a></li>
                <li><a href="#renommer"><i class="fa-solid fa-i-cursor"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_renommer')); ?></a></li>
                <li><a href="#supprimer"><i class="fa-solid fa-trash-can"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_supprimer')); ?></a></li>
                <li><a href="#selection-multiple"><i class="fa-solid fa-square-check"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_selection_multiple')); ?></a></li>
                <li><a href="#schema-usine"><i class="fa-solid fa-diagram-project"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_schema_usine')); ?></a></li>
                <li><a href="#categories-schema"><i class="fa-solid fa-draw-polygon"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_categories_schema')); ?></a></li>
                <li><a href="#source-verite"><i class="fa-solid fa-diagram-project"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_source_verite')); ?></a></li>
                <li><a href="#droits"><i class="fa-solid fa-shield-halved"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_droits')); ?></a></li>
                <li class="toc-sep"></li>
                <li><a href="#astuces"><i class="fa-solid fa-lightbulb"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_astuces')); ?></a></li>
                <li><a href="#glossaire"><i class="fa-solid fa-book"></i> <?php echo htmlspecialchars(t('aide_parc_machine.toc_glossaire')); ?></a></li>
        ...
        <main class="content">
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-circle-info"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_vue_ensemble')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.vue_lede'); ?></p>

                    <div class="tree-demo">
                        <span class="tn" style="background:#8e44ad;"><i class="fa-solid fa-industry"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_usine')); ?></span>
                        <span class="sep">→</span>
                        <span class="tn" style="background:var(--gelpam-orange);"><i class="fa-solid fa-layer-group"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_secteur')); ?></span>
                        <span class="sep">→</span>
                        <span class="tn" style="background:var(--accent);"><i class="fa-solid fa-arrow-right-long"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_ligne')); ?></span>
                        <span class="sep">→</span>
                        <span class="tn" style="background:var(--gelpam-green);"><i class="fa-solid fa-location-dot"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_zone')); ?></span>
                        <span class="sep">→</span>
                        <span class="tn" style="background:#7f8c8d;"><i class="fa-solid fa-gear"></i><?php echo htmlspecialchars(t('aide_parc_machine.tree_machine')); ?></span>
                    </div>

                    <p><?php echo t('aide_parc_machine.vue_p2'); ?></p>

                    <div class="shot">
                        <img src="img/aide/parc_machine_arbre.png" alt="<?php echo htmlspecialchars(t('aide_parc_machine.shot_arbre_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_parc_machine.shot_arbre_cap')); ?></div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-eye"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_tip_lecture_seule'); ?></p></div>
                    </div>
                </section>

                <section id="explorer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-magnifying-glass"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_explorer')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_parc_machine.explorer_lede')); ?></p>

                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-magnifying-glass"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_recherche_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_recherche_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-filter"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_filtrer_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_filtrer_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-angles-down"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_deplier_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_deplier_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-chevron-right"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_chevrons_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_chevrons_desc')); ?></p>
                        </div>
                    </div>
                </section>

                <section id="ajouter" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-plus"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_ajouter')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.ajouter_lede'); ?></p>

                    <div class="steps">
                        <div class="step">
                            <div class="step-num">1</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parc_machine.a_step1_titre')); ?></h4>
                            <p><?php echo t('aide_parc_machine.a_step1_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">2</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parc_machine.a_step2_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.a_step2_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">3</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parc_machine.a_step3_titre')); ?></h4>
                            <p><?php echo t('aide_parc_machine.a_step3_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">4</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_parc_machine.a_step4_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.a_step4_desc')); ?></p></div>
                        </div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-repeat"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_tip_reouvre'); ?></p></div>
                    </div>
                </section>

                <section id="modifier" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-pen"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_modifier')); ?></h2></div>

                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-pen"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_modifier_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_modifier_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-up-down-left-right"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_glisser_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_glisser_desc')); ?></p>
                        </div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-clock-rotate-left"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_tip_historique_suit'); ?></p></div>
                    </div>
                </section>

                <section id="renommer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-i-cursor"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_renommer')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.renommer_lede'); ?></p>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-arrows-split-up-and-left"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_tip_renommage_masse'); ?></p></div>
                    </div>

                    <p><?php echo t('aide_parc_machine.renommer_p2'); ?></p>
                </section>

                <section id="supprimer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-trash-can"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_supprimer')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_parc_machine.supprimer_lede')); ?></p>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_warn_suppression'); ?></p></div>
                    </div>
                </section>

                <section id="selection-multiple" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-square-check"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_selection_multiple')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.selection_lede'); ?></p>

                    <p><?php echo t('aide_parc_machine.selection_p2'); ?></p>
                </section>

                <section id="schema-usine" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-diagram-project"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_schema_usine')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.schema_lede'); ?></p>

                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-filter"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_tri_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_tri_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-box-open"></i> <?php echo htmlspecialchars(t('aide_parc_machine.card_cond_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.card_cond_desc')); ?></p>
                        </div>
                    </div>

                    <p><?php echo t('aide_parc_machine.schema_p2'); ?></p>
                    <ul>
                        <li><?php echo t('aide_parc_machine.li_fiche_technique'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_historique_bi'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_interventions'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_documentation'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_devis'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_aide_pannes'); ?></li>
                    </ul>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-circle-info"></i>
                        <div><p><?php echo htmlspecialchars(t('aide_parc_machine.callout_tip_plan_reprend')); ?></p></div>
                    </div>

                    <div class="callout callout-lock">
                        <i class="fa-solid fa-lock"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_lock_droits_fiche'); ?></p></div>
                    </div>

                    <h3 style="margin-top:18px;"><?php echo htmlspecialchars(t('aide_parc_machine.h3_modifier_plan')); ?></h3>
                    <p><?php echo t('aide_parc_machine.modifier_plan_p'); ?></p>
                    <ul>
                        <li><?php echo t('aide_parc_machine.li_texte_forme'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_categorie'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_couleurs'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_taille_rotation'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_comportement'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_supprimer_forme'); ?></li>
                    </ul>
                    <p><?php echo t('aide_parc_machine.p_ajouter_forme'); ?></p>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-rotate"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_tip_rotation_texte'); ?></p></div>
                    </div>
                </section>

                <section id="categories-schema" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-draw-polygon"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_categories_schema')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.categories_lede'); ?></p>

                    <p><?php echo htmlspecialchars(t('aide_parc_machine.categories_p2')); ?></p>
                    <ul>
                        <li><?php echo t('aide_parc_machine.li_apparence'); ?></li>
                        <li><?php echo t('aide_parc_machine.li_valeurs_depart'); ?></li>
                    </ul>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-lightbulb"></i>
                        <div><p><?php echo htmlspecialchars(t('aide_parc_machine.callout_tip_exemple_vis')); ?></p></div>
                    </div>
                </section>

                <section id="source-verite" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-diagram-project"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_source_verite')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_parc_machine.source_lede'); ?></p>

                    <div class="grid-2">
                        <div class="route-card">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_parc_machine.route_tag')); ?></span>
                            <h3><i class="fa-solid fa-pen-to-square"></i> <?php echo htmlspecialchars(t('aide_parc_machine.route1_titre')); ?></h3>
                            <p><?php echo t('aide_parc_machine.route1_desc'); ?></p>
                        </div>
                        <div class="route-card alt">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_parc_machine.route_tag')); ?></span>
                            <h3><i class="fa-solid fa-calendar-check"></i> <?php echo htmlspecialchars(t('aide_parc_machine.route2_titre')); ?></h3>
                            <p><?php echo htmlspecialchars(t('aide_parc_machine.route2_desc')); ?></p>
                        </div>
                    </div>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_parc_machine.callout_warn_absente'); ?></p></div>
                    </div>
                </section>

                <section id="droits" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_droits')); ?></h2></div>
                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_parc_machine.tbl_th_action')); ?></th><th><?php echo htmlspecialchars(t('aide_parc_machine.tbl_th_technicien')); ?></th><th><?php echo htmlspecialchars(t('aide_parc_machine.tbl_th_admin')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_parc_machine.droit1_action')); ?></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parc_machine.droit2_action')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parc_machine.droit3_action')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parc_machine.droit4_action')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_parc_machine.droit5_action')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>
                ...
                <section id="astuces" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-lightbulb"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_astuces')); ?></h2></div>
                    <ul>
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <li><?php echo t("aide_parc_machine.astuces_li{$i}"); ?></li>
                        <?php endfor; ?>
                    </ul>
                </section>

                <section id="glossaire" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-book"></i><h2><?php echo htmlspecialchars(t('aide_parc_machine.toc_glossaire')); ?></h2></div>
                    <dl class="gloss">
                        <?php for ($i = 1; $i <= 3; $i++): ?>
                        <div><dt><?php echo htmlspecialchars(t("aide_parc_machine.gloss{$i}_dt")); ?></dt><dd><?php echo htmlspecialchars(t("aide_parc_machine.gloss{$i}_dd")); ?></dd></div>
                        <?php endfor; ?>
                    </dl>
                </section>
                ...
                <section id="roadmap" class="aide-sec" style="margin-bottom:0;">
                    ...
                    <details class="devnote">
                        ...
                        <p style="margin-top:8px; font-size:0.88rem; color:#5a6b7a;"><?php echo htmlspecialchars(t('aide_parc_machine.devnote_intro')); ?></p>
                        <ul style="font-size:0.88rem; color:#5a6b7a;">
                            <li><?php echo t('aide_parc_machine.devnote_li1'); ?></li>
                            <li><?php echo t('aide_parc_machine.devnote_li2'); ?></li>
                            <li><?php echo t('aide_parc_machine.devnote_li3'); ?></li>
                        </ul>
                    </details>
                    <?php endif; ?>
