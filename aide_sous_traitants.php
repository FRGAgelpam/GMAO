...
<title><?php echo htmlspecialchars(t('aide_sous_traitants.page_title_tag')); ?></title>
...
.badge-demo { display: inline-flex; align-items: center; gap: 5px; font-weight: 700; font-size: 0.68rem; text-transform: uppercase; letter-spacing: 0.03em; padding: 4px 10px; border-radius: 999px; color: #fff; }
.badge-ok { background: #27ae60; }
.badge-nok { background: #e74c3c; }
...
<?php $breadcrumb_parent_label = t('aide_hub.breadcrumb'); $breadcrumb_parent_href = 'aide.php'; $breadcrumb_label = t('aide_hub.tuile_sous_traitants_titre'); include 'navbar.php'; ?>

<div class="main-content">

    <div class="crumb"><span><i class="fa-solid fa-house"></i> <?php echo htmlspecialchars(t('aide_common.centre_aide')); ?></span> <span>/</span> <span><?php echo htmlspecialchars(t('aide_hub.tuile_sous_traitants_titre')); ?></span></div>
    ...
    <div class="hero">
        ...
        <h1><?php echo htmlspecialchars(t('aide_hub.tuile_sous_traitants_titre')); ?></h1>
        <p class="tagline"><?php echo htmlspecialchars(t('aide_sous_traitants.hero_tagline')); ?></p>
        <div class="hero-meta">
            <span class="hero-pill"><?php echo t('aide_sous_traitants.pill_version'); ?></span>
            <span class="hero-pill"><?php echo t('aide_sous_traitants.pill_updated'); ?></span>
            <span class="hero-pill"><?php echo t('aide_sous_traitants.pill_ecrans'); ?></span>
            <span class="hero-pill"><i class="fa-solid fa-users"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.pill_roles')); ?></span>
        </div>
    </div>
    ...
    <div class="layout">
        <nav class="toc-card" aria-label="<?php echo htmlspecialchars(t('aide_common.sommaire')); ?>">
            ...
            <ul class="toc-list">
                <li><a href="#vue-ensemble"><i class="fa-solid fa-circle-info"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_vue_ensemble')); ?></a></li>
                <li><a href="#planifier"><i class="fa-solid fa-calendar-plus"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_planifier')); ?></a></li>
                <li><a href="#presence"><i class="fa-solid fa-person-walking-arrow-right"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_presence')); ?></a></li>
                <li><a href="#cloturer"><i class="fa-solid fa-clipboard-check"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_cloturer')); ?></a></li>
                <li><a href="#pdp"><i class="fa-solid fa-shield-halved"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_pdp')); ?></a></li>
                <li><a href="#annuaire"><i class="fa-solid fa-address-book"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_annuaire')); ?></a></li>
                <li><a href="#historique"><i class="fa-solid fa-clock-rotate-left"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_historique')); ?></a></li>
                <li><a href="#droits"><i class="fa-solid fa-shield-halved"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_droits')); ?></a></li>
                <li class="toc-sep"></li>
                <li><a href="#astuces"><i class="fa-solid fa-lightbulb"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_astuces')); ?></a></li>
                <li><a href="#glossaire"><i class="fa-solid fa-book"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.toc_glossaire')); ?></a></li>
        ...
        <main class="content">
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-circle-info"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_vue_ensemble')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_sous_traitants.vue_lede'); ?></p>

                    <p><?php echo htmlspecialchars(t('aide_sous_traitants.vue_p2')); ?></p>
                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-calendar-days"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.card_planification_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.card_planification_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-circle-check" style="color:var(--success);"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.card_sursite_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.card_sursite_desc')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-clock-rotate-left"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.card_historique_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.card_historique_desc')); ?></p>
                        </div>
                    </div>

                    <p><?php echo t('aide_sous_traitants.vue_p3'); ?></p>

                    <div class="shot">
                        <img src="img/aide/sous_traitants_dashboard.png" alt="<?php echo htmlspecialchars(t('aide_sous_traitants.shot_dashboard_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.shot_dashboard_cap')); ?></div>
                    </div>
                </section>

                <section id="planifier" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-calendar-plus"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_planifier')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_sous_traitants.planifier_lede'); ?></p>

                    <div class="steps">
                        <div class="step">
                            <div class="step-num">1</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_sous_traitants.p_step1_titre')); ?></h4>
                            <p><?php echo t('aide_sous_traitants.p_step1_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">2</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_sous_traitants.p_step2_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.p_step2_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">3</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_sous_traitants.p_step3_titre')); ?></h4>
                            <p><?php echo t('aide_sous_traitants.p_step3_desc'); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">4</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_sous_traitants.p_step4_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.p_step4_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">5</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_sous_traitants.p_step5_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.p_step5_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">6</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_sous_traitants.p_step6_titre')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.p_step6_desc')); ?></p></div>
                        </div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-hashtag"></i>
                        <div><p><?php echo t('aide_sous_traitants.callout_tip_numero_bi'); ?></p></div>
                    </div>

                    <p><?php echo t('aide_sous_traitants.planifier_p2'); ?></p>
                </section>

                <section id="presence" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-person-walking-arrow-right"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_presence')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_sous_traitants.presence_lede')); ?></p>

                    <div class="cycle">
                        <div class="cy-step">
                            <span class="pill pill-afaire"><span class="pill-dot"></span><?php echo htmlspecialchars(t('aide_sous_traitants.cy_planifie_label')); ?></span>
                            <div class="cy-trig"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_planifie_trig')); ?><span class="cy-who"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_who_vous')); ?></span></div>
                        </div>
                        <div class="cy-arrow"><i class="fa-solid fa-arrow-right-long"></i></div>
                        <div class="cy-step">
                            <span class="pill pill-cours"><span class="pill-dot"></span><?php echo htmlspecialchars(t('aide_sous_traitants.cy_sursite_label')); ?></span>
                            <div class="cy-trig"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_sursite_trig')); ?><span class="cy-who"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_who_vous')); ?></span></div>
                        </div>
                        <div class="cy-arrow"><i class="fa-solid fa-arrow-right-long"></i></div>
                        <div class="cy-step">
                            <span class="pill pill-afaire"><span class="pill-dot"></span><?php echo htmlspecialchars(t('aide_sous_traitants.cy_pause_label')); ?></span>
                            <div class="cy-trig"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_pause_trig')); ?><span class="cy-who"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_who_vous')); ?></span></div>
                        </div>
                        <div class="cy-arrow"><i class="fa-solid fa-arrow-right-long"></i></div>
                        <div class="cy-step">
                            <span class="pill pill-termine"><span class="pill-dot"></span><?php echo htmlspecialchars(t('aide_sous_traitants.cy_termine_label')); ?></span>
                            <div class="cy-trig"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_termine_trig')); ?><span class="cy-who"><?php echo htmlspecialchars(t('aide_sous_traitants.cy_who_vous')); ?></span></div>
                        </div>
                    </div>

                    <p><?php echo t('aide_sous_traitants.presence_p2'); ?></p>
                </section>

                <section id="cloturer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-clipboard-check"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_cloturer')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_sous_traitants.cloturer_lede'); ?></p>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_sous_traitants.callout_warn_compte_rendu'); ?></p></div>
                    </div>

                    <p><?php echo t('aide_sous_traitants.cloturer_p2'); ?></p>
                </section>

                <section id="pdp" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_pdp')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_sous_traitants.pdp_lede')); ?></p>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl1_th_badge')); ?></th><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl1_th_condition')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><span class="badge-demo badge-ok"><?php echo htmlspecialchars(t('aide_sous_traitants.badge_valide')); ?></span></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.cond_valide')); ?></td></tr>
                                <tr><td><span class="badge-demo badge-nok"><?php echo htmlspecialchars(t('aide_sous_traitants.badge_expire')); ?></span></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.cond_expire')); ?></td></tr>
                                <tr><td><span class="badge-demo badge-pending"><?php echo htmlspecialchars(t('aide_sous_traitants.badge_attente')); ?></span></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.cond_attente')); ?></td></tr>
                            </tbody>
                        </table>
                    </div>

                    <p><?php echo t('aide_sous_traitants.pdp_p2'); ?></p>
                    <div class="grid-2">
                        <div class="route-card">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_sous_traitants.route_tag_annuel')); ?></span>
                            <h3><i class="fa-solid fa-calendar"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.route_annuel_titre')); ?></h3>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.route_annuel_desc')); ?></p>
                        </div>
                        <div class="route-card alt">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_sous_traitants.route_tag_ponctuel')); ?></span>
                            <h3><i class="fa-solid fa-file-signature"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.route_ponctuel_titre')); ?></h3>
                            <p><?php echo htmlspecialchars(t('aide_sous_traitants.route_ponctuel_desc')); ?></p>
                        </div>
                    </div>

                    <div class="callout callout-tip">
                        <i class="fa-solid fa-file-shield"></i>
                        <div><p><?php echo t('aide_sous_traitants.callout_tip_bouclier'); ?></p></div>
                    </div>

                    <p><?php echo t('aide_sous_traitants.pdp_p3'); ?></p>
                </section>

                <section id="annuaire" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-address-book"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_annuaire')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_sous_traitants.annuaire_lede'); ?></p>

                    <p><?php echo htmlspecialchars(t('aide_sous_traitants.annuaire_p2')); ?></p>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl2_th_champ')); ?></th><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl2_th_detail')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_nom_champ')); ?></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_nom_detail')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_contact_champ')); ?></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_contact_detail')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_type_champ')); ?></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_type_detail')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_fin_champ')); ?></td><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_fin_detail')); ?></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.row_fichier_champ')); ?></td><td><?php echo t('aide_sous_traitants.row_fichier_detail'); ?></td></tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_sous_traitants.callout_warn_suppression_entreprise'); ?></p></div>
                    </div>
                </section>

                <section id="historique" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-clock-rotate-left"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_historique')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_sous_traitants.historique_lede'); ?></p>

                    <p><?php echo t('aide_sous_traitants.historique_p2'); ?></p>
                </section>

                <section id="droits" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_droits')); ?></h2></div>
                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl3_th_action')); ?></th><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl3_th_technicien')); ?></th><th><?php echo htmlspecialchars(t('aide_sous_traitants.tbl3_th_admin')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.droit1_action')); ?></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.droit2_action')); ?></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.droit3_action')); ?></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.droit4_action')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.droit4_tech')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_sous_traitants.droit5_action')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_sous_traitants.droit5_tech')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>
                ...
                <section id="astuces" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-lightbulb"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_astuces')); ?></h2></div>
                    <ul>
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <li><?php echo t("aide_sous_traitants.astuces_li{$i}"); ?></li>
                        <?php endfor; ?>
                    </ul>
                </section>

                <section id="glossaire" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-book"></i><h2><?php echo htmlspecialchars(t('aide_sous_traitants.toc_glossaire')); ?></h2></div>
                    <dl class="gloss">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <div><dt><?php echo htmlspecialchars(t("aide_sous_traitants.gloss{$i}_dt")); ?></dt><dd><?php echo htmlspecialchars(t("aide_sous_traitants.gloss{$i}_dd")); ?></dd></div>
                        <?php endfor; ?>
                    </dl>
                </section>
                ...
                <section id="roadmap" class="aide-sec" style="margin-bottom:0;">
                    ...
                    <details class="devnote">
                        ...
                        <p style="margin-top:8px; font-size:0.88rem; color:#5a6b7a;"><?php echo htmlspecialchars(t('aide_sous_traitants.devnote_intro')); ?></p>
                        <ul style="font-size:0.88rem; color:#5a6b7a;">
                            <li><?php echo htmlspecialchars(t('aide_sous_traitants.devnote_li1')); ?></li>
                            <li><?php echo t('aide_sous_traitants.devnote_li2'); ?></li>
                            <li><?php echo t('aide_sous_traitants.devnote_li3'); ?></li>
                            <li><?php echo t('aide_sous_traitants.devnote_li4'); ?></li>
                        </ul>
                    </details>
                    <?php endif; ?>
