...
<title><?php echo htmlspecialchars(t('aide_logs.page_title_tag')); ?></title>
...
.badge-demo { display: inline-flex; align-items: center; font-weight: 700; font-size: 0.68rem; text-transform: uppercase; letter-spacing: 0.03em; padding: 4px 10px; border-radius: 6px; }
.badge-add { color: #27ae60; background: rgba(39,174,96,0.12); }
.badge-edit { color: #2980b9; background: rgba(41,128,185,0.12); }
.badge-delete { color: #c0392b; background: rgba(192,57,43,0.12); }
.badge-login { color: #d35400; background: rgba(211,84,0,0.12); }
.badge-default { color: #666; background: #eee; }
</style>
...
<?php $breadcrumb_parent_label = t('aide_hub.breadcrumb'); $breadcrumb_parent_href = 'aide.php'; $breadcrumb_label = t('tag.journal_activite'); include 'navbar.php'; ?>

<div class="main-content">

    <div class="crumb"><span><i class="fa-solid fa-house"></i> <?php echo htmlspecialchars(t('aide_common.centre_aide')); ?></span> <span>/</span> <span><?php echo htmlspecialchars(t('aide_hub.tuile_logs_titre')); ?></span></div>
    ...
    <div class="hero">
        ...
        <h1><?php echo htmlspecialchars(t('aide_hub.tuile_logs_titre')); ?></h1>
        <p class="tagline"><?php echo htmlspecialchars(t('aide_logs.hero_tagline')); ?></p>
        <div class="hero-meta">
            <span class="hero-pill"><?php echo t('aide_logs.pill_version'); ?></span>
            <span class="hero-pill"><?php echo t('aide_logs.pill_updated'); ?></span>
            <span class="hero-pill"><?php echo t('aide_logs.pill_ecran'); ?></span>
    ...
    <div class="layout">
        <nav class="toc-card" aria-label="<?php echo htmlspecialchars(t('aide_common.sommaire')); ?>">
            ...
            <ul class="toc-list">
                <li><a href="#vue-ensemble"><i class="fa-solid fa-circle-info"></i> <?php echo htmlspecialchars(t('aide_logs.toc_vue_ensemble')); ?></a></li>
                <li><a href="#lire-une-ligne"><i class="fa-solid fa-table-list"></i> <?php echo htmlspecialchars(t('aide_logs.toc_lire')); ?></a></li>
                <li><a href="#quoi-journalise"><i class="fa-solid fa-list-check"></i> <?php echo htmlspecialchars(t('aide_logs.toc_quoi')); ?></a></li>
                <li><a href="#filtrer"><i class="fa-solid fa-filter"></i> <?php echo htmlspecialchars(t('aide_logs.toc_filtrer')); ?></a></li>
                <li><a href="#limites"><i class="fa-solid fa-triangle-exclamation"></i> <?php echo htmlspecialchars(t('aide_logs.toc_limites')); ?></a></li>
                <li><a href="#vider"><i class="fa-solid fa-trash-can"></i> <?php echo htmlspecialchars(t('aide_logs.toc_vider')); ?></a></li>
                <li><a href="#droits"><i class="fa-solid fa-shield-halved"></i> <?php echo htmlspecialchars(t('aide_logs.toc_droits')); ?></a></li>
                <li class="toc-sep"></li>
                <li><a href="#astuces"><i class="fa-solid fa-lightbulb"></i> <?php echo htmlspecialchars(t('aide_logs.toc_astuces')); ?></a></li>
                <li><a href="#glossaire"><i class="fa-solid fa-book"></i> <?php echo htmlspecialchars(t('aide_logs.toc_glossaire')); ?></a></li>
        ...
        <main class="content">
            <div class="card">
                ...
                <section id="vue-ensemble" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-circle-info"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_vue_ensemble')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_logs.vue_ensemble_lede'); ?></p>

                    <div class="callout callout-lock">
                        <i class="fa-solid fa-lock"></i>
                        <div><p><?php echo t('aide_logs.vue_ensemble_lock'); ?></p></div>
                    </div>
                </section>

                <section id="lire-une-ligne" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-table-list"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_lire')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_logs.lire_lede')); ?></p>

                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_logs.col_colonne')); ?></th><th><?php echo htmlspecialchars(t('aide_logs.col_contenu')); ?></th></tr></thead>
                            <tbody>
                                <?php for ($i = 1; $i <= 4; $i++): ?>
                                <tr><td><?php echo htmlspecialchars(t("aide_logs.col{$i}_nom")); ?></td><td><?php echo t("aide_logs.col{$i}_desc"); ?></td></tr>
                                <?php endfor; ?>
                            </tbody>
                        </table>
                    </div>

                    <p><?php echo htmlspecialchars(t('aide_logs.badges_intro')); ?></p>
                    <ul>
                        <li><span class="badge-demo badge-add"><?php echo htmlspecialchars(t('aide_logs.badge_add_label')); ?></span> <?php echo htmlspecialchars(t('aide_logs.badge_add_suffix')); ?></li>
                        <li><span class="badge-demo badge-edit"><?php echo htmlspecialchars(t('aide_logs.badge_edit_label')); ?></span> <?php echo htmlspecialchars(t('aide_logs.badge_edit_suffix')); ?></li>
                        <li><span class="badge-demo badge-delete"><?php echo htmlspecialchars(t('aide_logs.badge_delete_label')); ?></span> <?php echo htmlspecialchars(t('aide_logs.badge_delete_suffix')); ?></li>
                        <li><span class="badge-demo badge-login"><?php echo htmlspecialchars(t('aide_logs.badge_login_label')); ?></span> <?php echo htmlspecialchars(t('aide_logs.badge_login_suffix')); ?></li>
                        <li><span class="badge-demo badge-default"><?php echo htmlspecialchars(t('aide_logs.badge_default_label')); ?></span> <?php echo htmlspecialchars(t('aide_logs.badge_default_suffix')); ?></li>
                    </ul>

                    <p><?php echo t('aide_logs.lire_footer'); ?></p>
                </section>

                <section id="quoi-journalise" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-list-check"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_quoi')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_logs.quoi_lede')); ?></p>

                    <div class="grid-2">
                        <div class="route-card">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_logs.trace_tag')); ?></span>
                            <h3><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_logs.trace_h3')); ?></h3>
                            <ul>
                                <li><?php echo htmlspecialchars(t('aide_logs.trace_li1')); ?></li>
                                <li><?php echo htmlspecialchars(t('aide_logs.trace_li2')); ?></li>
                                <li><?php echo htmlspecialchars(t('aide_logs.trace_li3')); ?></li>
                                <li><?php echo htmlspecialchars(t('aide_logs.trace_li4')); ?></li>
                                <li><?php echo t('aide_logs.trace_li5'); ?></li>
                            </ul>
                        </div>
                        <div class="route-card alt">
                            <span class="route-tag"><?php echo htmlspecialchars(t('aide_logs.non_trace_tag')); ?></span>
                            <h3><i class="fa-solid fa-xmark"></i> <?php echo htmlspecialchars(t('aide_logs.non_trace_h3')); ?></h3>
                            <ul>
                                <li><?php echo htmlspecialchars(t('aide_logs.non_trace_li1')); ?></li>
                                <li><?php echo htmlspecialchars(t('aide_logs.non_trace_li2')); ?></li>
                                <li><?php echo t('aide_logs.non_trace_li3'); ?></li>
                                <li><?php echo htmlspecialchars(t('aide_logs.non_trace_li4')); ?></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="callout callout-warn">
                        ...
                        <div><p><?php echo t('aide_logs.quoi_warn'); ?></p></div>
                    </div>
                </section>

                <section id="filtrer" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-filter"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_filtrer')); ?></h2></div>
                    <p class="lede"><?php echo htmlspecialchars(t('aide_logs.filtrer_lede')); ?></p>

                    <div class="shot">
                        <img src="img/aide/logs_filtres.png" alt="<?php echo htmlspecialchars(t('aide_logs.shot_filtres_alt')); ?>">
                        <div class="shot-cap"><i class="fa-solid fa-camera"></i> <?php echo htmlspecialchars(t('aide_logs.shot_filtres_cap')); ?></div>
                    </div>

                    <div class="cases">
                        <div class="case-card">
                            <h4><i class="fa-solid fa-user"></i> <?php echo htmlspecialchars(t('aide_logs.case_user_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_logs.case_user_p')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-filter"></i> <?php echo htmlspecialchars(t('aide_logs.case_action_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_logs.case_action_p')); ?></p>
                        </div>
                        <div class="case-card">
                            <h4><i class="fa-solid fa-magnifying-glass"></i> <?php echo htmlspecialchars(t('aide_logs.case_recherche_h4')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_logs.case_recherche_p')); ?></p>
                        </div>
                    </div>

                    <p><?php echo t('aide_logs.filtrer_footer'); ?></p>
                </section>

                <section id="limites" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-triangle-exclamation"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_limites')); ?></h2></div>
                    <ul>
                        <li><?php echo t('aide_logs.limites_li1'); ?></li>
                        <li><?php echo t('aide_logs.limites_li2'); ?></li>
                        <li><?php echo t('aide_logs.limites_li3'); ?></li>
                    </ul>
                </section>

                <section id="vider" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-trash-can"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_vider')); ?></h2></div>
                    <p class="lede"><?php echo t('aide_logs.vider_lede'); ?></p>

                    <div class="steps">
                        <div class="step">
                            <div class="step-num">1</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_logs.vider_step1_title')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_logs.vider_step1_desc')); ?></p></div>
                        </div>
                        <div class="step">
                            <div class="step-num">2</div>
                            <div><h4><?php echo htmlspecialchars(t('aide_logs.vider_step2_title')); ?></h4>
                            <p><?php echo htmlspecialchars(t('aide_logs.vider_step2_desc')); ?></p></div>
                        </div>
                    </div>

                    <div class="callout callout-warn">
                        <i class="fa-solid fa-triangle-exclamation"></i>
                        <div><p><?php echo t('aide_logs.vider_warn'); ?></p></div>
                    </div>
                </section>

                <section id="droits" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-shield-halved"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_droits')); ?></h2></div>
                    <div class="tbl-wrap">
                        <table>
                            <thead><tr><th><?php echo htmlspecialchars(t('aide_logs.droits_action')); ?></th><th><?php echo htmlspecialchars(t('aide_logs.droits_tech')); ?></th><th><?php echo htmlspecialchars(t('aide_logs.droits_admin')); ?></th></tr></thead>
                            <tbody>
                                <tr><td><?php echo htmlspecialchars(t('aide_logs.droits1')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> <?php echo htmlspecialchars(t('aide_common.non')); ?></span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_logs.droits2')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> —</span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                                <tr><td><?php echo htmlspecialchars(t('aide_logs.droits3')); ?></td><td><span class="yn n"><i class="fa-solid fa-lock"></i> —</span></td><td><span class="yn y"><i class="fa-solid fa-check"></i> <?php echo htmlspecialchars(t('aide_common.oui')); ?></span></td></tr>
                            </tbody>
                        </table>
                    </div>
                </section>
                ...
                <section id="astuces" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-lightbulb"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_astuces')); ?></h2></div>
                    <ul>
                        <li><?php echo t('aide_logs.astuces_li1'); ?></li>
                        <li><?php echo t('aide_logs.astuces_li2'); ?></li>
                        <li><?php echo t('aide_logs.astuces_li3'); ?></li>
                        <li><?php echo t('aide_logs.astuces_li4'); ?></li>
                    </ul>
                </section>

                <section id="glossaire" class="aide-sec">
                    <div class="sec-eyebrow"><i class="fa-solid fa-book"></i><h2><?php echo htmlspecialchars(t('aide_logs.toc_glossaire')); ?></h2></div>
                    <dl class="gloss">
                        <?php for ($i = 1; $i <= 4; $i++): ?>
                        <div><dt><?php echo htmlspecialchars(t("aide_logs.gloss{$i}_dt")); ?></dt><dd><?php echo htmlspecialchars(t("aide_logs.gloss{$i}_dd")); ?></dd></div>
                        <?php endfor; ?>
                    </dl>
                </section>
                ...
                <section id="roadmap" class="aide-sec" style="margin-bottom:0;">
                    ...
                    <details class="devnote">
                        ...
                        <p style="margin-top:8px; font-size:0.88rem; color:#5a6b7a;"><?php echo htmlspecialchars(t('aide_logs.devnote_intro')); ?></p>
                        <ul style="font-size:0.88rem; color:#5a6b7a;">
                            <li><?php echo t('aide_logs.devnote_li1'); ?></li>
                            <li><?php echo t('aide_logs.devnote_li2'); ?></li>
                            <li><?php echo t('aide_logs.devnote_li3'); ?></li>
                        </ul>
                    </details>
                    <?php endif; ?>
